...
import com.fitareq.oldbookstore.databinding.StoreItemCardBinding;
import com.fitareq.oldbookstore.ui.book_details.BookDetailsActivity;
import com.squareup.picasso.Picasso;

import java.util.List;

public class StoreAdapter extends RecyclerView.Adapter<StoreAdapter.ItemsViewHolder> {

    private List<Item> items;
    private boolean isOwnBook;

    public StoreAdapter(List<Item> items, boolean isOwnBook) {
        this.items = items;
    ...
    public ItemsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ItemsViewHolder(StoreItemCardBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }
    ...
    class ItemsViewHolder extends RecyclerView.ViewHolder {
        StoreItemCardBinding binding;

        public ItemsViewHolder(@NonNull StoreItemCardBinding binding) {
